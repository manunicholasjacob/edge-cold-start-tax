...
\newcommand{\POLICYPARA}{Across both workloads and all budgets, \gdtax{} never underperforms LRU
or LFU, and it reduces energy per request by up to \SI{15}{\percent} (Zipf) and
